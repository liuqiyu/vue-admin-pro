    ...
    <el-row :gutter="20">
      <el-col :span="4">
        ...
        <div id="itempannel" class="ph left">
          <div class="getItem" data-type="node" data-shape="flow-image" data-size="120*48" data-label="常规节点" data-color="red" data-image="//www.baidu.com/img/superlogo_c4d7df0a003d3db9b65e9ef0fe6da1ec.png?qua=high&where=super">
            <img draggable="false" src="//www.baidu.com/img/superlogo_c4d7df0a003d3db9b65e9ef0fe6da1ec.png?qua=high&where=super"  alt="" srcset="" style="width: 100px; height: 40px;">
          </div>
          ...
          <div class="getItem" data-type="node" data-shape="customNode" data-label="路由器"
               data-image="http://hbimg.b0.upaiyun.com/d56edaffdd0b0f9a76a827df7d19da862a9137141e26-guY1sU_fw658">
            <img draggable="false" src="http://hbimg.b0.upaiyun.com/d56edaffdd0b0f9a76a827df7d19da862a9137141e26-guY1sU_fw658">
          </div>

          <img src="https://gw.alipayobjects.com/zos/rmsportal/NKmorGEesOtYawmMJkhi.svg"
               class="getItem" data-type="node" data-shape="customNode" data-size="80*48" data-label="路由器" data-color="#722ED1"
               data-image="https://gw.alipayobjects.com/zos/rmsportal/zByaCkBKPacvgJqFgtwy.svg"/>
        </div>
      </el-col>
      <el-col :span="16">
        <!-- 主画布 -->
